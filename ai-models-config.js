/**
 * AI Models Configuration - Browser Version
 * This file is loaded by the browser in index.html
 * For backend/Node.js use, see ai-models-config.cjs
 */
...
const AI_MODELS = {
    anthropic: {
        ...
        models: [
            // Claude 4.5 Series (Latest - Sept-Nov 2025)
            { id: 'claude-sonnet-4-5-20250929', name: 'Claude Sonnet 4.5 (Sept 2025 - Latest)', maxOutput: 64000, contextWindow: 200000 },
            { id: 'claude-haiku-4-5-20251001', name: 'Claude Haiku 4.5 (Oct 2025 - Fastest)', maxOutput: 64000, contextWindow: 200000 },
            ...
            { id: 'claude-3-5-sonnet-20240620', name: 'Claude 3.5 Sonnet (June 2024)', maxOutput: 8192, contextWindow: 200000 },
    ...
    mistral: {
        ...
        models: [
            { id: 'mistral-large-latest', name: 'Mistral Large (Latest)', maxOutput: 8192, contextWindow: 128000 },
            { id: 'mistral-medium-latest', name: 'Mistral Medium', maxOutput: 8192, contextWindow: 32000 },
...
function getMaxOutputTokens(provider, modelId) {
    ...
    if (!providerConfig) return 8192;
    
    const tokenMap = providerConfig.maxOutputTokens;
    for (const pattern in tokenMap) {
        if (modelId.includes(pattern)) {
            return tokenMap[pattern];
        }
    }
    return tokenMap.default || 8192;
}
